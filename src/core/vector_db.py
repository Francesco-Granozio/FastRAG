...
class QdrantStorage:
    ...
    def delete_by_source(self, source_id: str) -> int:
        ...
        # Prima conta quanti punti verranno cancellati
        ...
        # Conta tutti i punti che verranno cancellati
        count = 0
        offset = None
        while True:
            result, next_offset = self.client.scroll(
        ...
        # Cancella tutti i punti con questo source_id
        # Usa PointsSelector con Filter per cancellare per filtro
